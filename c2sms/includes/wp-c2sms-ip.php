...
class WP_C2SMS_IP_List_Table extends WP_List_Table {
	var $data;
    ...
    function __construct(){
        ...
        parent::__construct( array(
            'singular'  => 'ip blacklist',     //singular name of the listed records
            'plural'    => 'ip',    //plural name of the listed records
            'ajax'      => true        //does this table support ajax?
        ) );
        
		$this->data = (array)$sms->GetIpList();
    ...
    function column_default($item, $column_name){
		...
		$actions = array(
            'delete'    => sprintf('<a href="admin.php?page=wp-c2sms-ip&action=delete&ip=%s">Delete</a>',$item['ip']),
        );
